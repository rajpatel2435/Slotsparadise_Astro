...
/* empty css                          */
import { e as createAstro, f as createComponent, A as AstroError, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, u as unescapeHTML, i as renderComponent, F as Fragment, j as renderSlot, k as renderHead } from '../astro_j2t8kCZ3.mjs';
import 'kleur/colors';
import 'clsx';
import { optimize } from 'svgo';
/* empty css                          */
import { i as isESMImportedImage, g as getImage$1 } from '../astro/assets-service_djn6lNJ-.mjs';
...
Casino News
            ...
            world. Stay informed, and stay ahead of the game, with Casino News.</span> </p> </div> </div> <section class="news_page max-w-[1440px] mx-auto px-4 my-16"> ${page && page.data ? page.data.map((post) => renderTemplate`${renderComponent($$result2, "NewsPostCategory", $$NewsPostCategory, { "href": post.node.uri, "title": post.node.title, "body": post.node.excerpt, "src": post.node.featuredImage.node.sourceUrl, "alt": post.node.featuredImage.node.altText, "excerpt": post.node.excerpt, "slug": post.node.slug, "uri": post.node.uri })}`) : renderTemplate`<p>No data available</p>`} ${page && page.url.prev ? renderTemplate`<a${addAttribute(page.url.prev, "href")}>Previous</a>` : null} ${page && page.url.next ? renderTemplate`<a${addAttribute(page.url.next, "href")}>Next</a>` : null} </section> </div> ` })}`;
...
export { $$Image as $, ____page_ as _, $$NewsPostCategory as a, $$Layout as b, imageConfig as i, wpquery as w };
